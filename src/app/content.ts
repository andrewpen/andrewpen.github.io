...
export const skills = [
  ...
  },
  {
    ...
    icon: RefreshCw,
    level: 88,
    desc: "Guided an 18-month enterprise rebranding and led adoption of new systems across dozens of teams, through partnership, not mandate.",
  },
];
...
export const roles = [
  {
    ...
    achievements: [
      ...
      "Manage managers: lead Associate Directors of Design, Engineering, and Product across US and India, building a high-performing, multi-disciplinary leadership layer",
      "Led design system rebranding: an 18-month enterprise rebranding overhaul with new visual identity, dynamic type, and built-in video transcripts",
      "Secured additional capital based on performance evidence to accelerate 2026 initiatives",
      ...
      "Reduced system complexity and accumulated technical debt through rebranding work, delivering a more opinionated, scalable platform",
    ],
  },
  {
    company: "Verizon",
...
export const projects = [
  ...
  },
  {
    ...
    title: "Verizon Design System (VDS) — Rebranding",
    text: "Transformed VDS from a component library into an opinionated, scalable design infrastructure platform. Led an 18-month rebranding reducing complexity, enforcing standards, and embedding accessibility-by-default. Achieved 86% adoption across Verizon product teams, exceeding the 75% target without mandate.",
    metric: "86% adoption · Fortune 50 scale",
  },
  {
    tag: "Mobile Platforms",
    title: "VDS Native — iOS & Android Parity",
    text: "Delivered VDS Native libraries for iOS (SwiftUI) and Android (Jetpack Compose), reaching 48 components and achieving full mobile parity with the web system, a year ahead of the original roadmap.",
    metric: "48 components · 1 year early",
  },
];
